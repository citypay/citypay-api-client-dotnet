...
namespace CityPayAPI.Model
{
    ...
    /// TokenRequestModel
    /// </summary>
    [DataContract(Name = "TokenRequestModel")]
    public partial class TokenRequestModel : IEquatable<TokenRequestModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenRequestModel" /> class.
        /// </summary>
        ...
        /// <param name="amountValue">Specifies the intended value of the transaction in the lowest denomination with no spacing characters or decimal point. This is the net total to be processed. An example of £74.95 would be presented as 7495. (required).</param>
        ...
        public TokenRequestModel(string accountno = default(string), int amountValue = default(int), CardHolder cardholder = default(CardHolder), Cart cart = default(Cart), string clientVersion = default(string), Config config = default(Config), string email = default(string), string identifier = default(string), int merchantid = default(int), string subscriptionId = default(string), string txType = default(string))
        {
            this.AmountValue = amountValue;
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for TokenRequestModel and cannot be null");
        ...
        [DataMember(Name = "amount_value", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as TokenRequestModel);
        }

        /// <summary>
        /// Returns true if TokenRequestModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenRequestModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenRequestModel input)
        {
            if (input == null)
                return false;

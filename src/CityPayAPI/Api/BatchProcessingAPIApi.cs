...
namespace CityPayAPI.Api
{
    ...
    /// </summary>
    public interface IBatchProcessingAPIApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBatchProcessingAPIApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBatchProcessingAPIApi : IBatchProcessingAPIApiSync, IBatchProcessingAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BatchProcessingAPIApi : IBatchProcessingAPIApi
    {
        private CityPayAPI.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BatchProcessingAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BatchProcessingAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public BatchProcessingAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public BatchProcessingAPIApi(CityPayAPI.Client.Configuration configuration)
        {
        ...
        public BatchProcessingAPIApi(CityPayAPI.Client.ISynchronousClient client, CityPayAPI.Client.IAsynchronousClient asyncClient, CityPayAPI.Client.IReadableConfiguration configuration)
        {
        ...
        public CityPayAPI.Client.ApiResponse<ProcessBatchResponse> BatchProcessRequestWithHttpInfo(ProcessBatchRequest processBatchRequest)
        {
            ...
            if (processBatchRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'processBatchRequest' when calling BatchProcessingAPIApi->BatchProcessRequest");
        ...
        public CityPayAPI.Client.ApiResponse<BatchReportResponseModel> BatchReportRequestWithHttpInfo(BatchReportRequest batchReportRequest)
        {
            ...
            if (batchReportRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'batchReportRequest' when calling BatchProcessingAPIApi->BatchReportRequest");
        ...
        public CityPayAPI.Client.ApiResponse<CheckBatchStatusResponse> CheckBatchStatusRequestWithHttpInfo(CheckBatchStatus checkBatchStatus)
        {
            ...
            if (checkBatchStatus == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'checkBatchStatus' when calling BatchProcessingAPIApi->CheckBatchStatusRequest");

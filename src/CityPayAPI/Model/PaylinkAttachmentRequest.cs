...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkAttachmentRequest : IEquatable<PaylinkAttachmentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkAttachmentRequest);
        }

        /// <summary>
        /// Returns true if PaylinkAttachmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkAttachmentRequest to be compared</param>
        /// <returns>Boolean</returns>

...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkCardHolder : IEquatable<PaylinkCardHolder>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkCardHolder);
        }

        /// <summary>
        /// Returns true if PaylinkCardHolder instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkCardHolder to be compared</param>
        /// <returns>Boolean</returns>

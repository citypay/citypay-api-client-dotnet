...
{
    /// <summary>
    ///  Class for testing AuthorisationAndPaymentAPIApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AuthorisationAndPaymentAPIApiTests : IDisposable
    {
        private AuthorisationAndPaymentAPIApi instance;

        public AuthorisationAndPaymentAPIApiTests()
        {
            instance = new AuthorisationAndPaymentAPIApi();
        }
        ...
        /// <summary>
        /// Test an instance of AuthorisationAndPaymentAPIApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AuthorisationAndPaymentAPIApi
            //Assert.IsType<AuthorisationAndPaymentAPIApi>(instance);
        }

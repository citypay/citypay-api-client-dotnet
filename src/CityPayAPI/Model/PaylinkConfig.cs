...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkConfig : IEquatable<PaylinkConfig>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkConfig);
        }

        /// <summary>
        /// Returns true if PaylinkConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaylinkConfig input)
        {
            ...
            return 
                ...
                (
                    ...
                    input.FieldGuard != null &&
                    this.FieldGuard.SequenceEqual(input.FieldGuard)
                ) && 
                (
                    this.LockParams == input.LockParams ||
                    this.LockParams != null &&
                    input.LockParams != null &&
                    this.LockParams.SequenceEqual(input.LockParams)
                ) && 
                (

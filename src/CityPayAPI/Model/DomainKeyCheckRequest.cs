...
namespace CityPayAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DomainKeyCheckRequest")]
    public partial class DomainKeyCheckRequest : IEquatable<DomainKeyCheckRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainKeyCheckRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DomainKeyCheckRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainKeyCheckRequest" /> class.
        /// </summary>
        /// <param name="domainKey">The domain key to check.  (required).</param>
        ...
        /// </summary>
        /// <value>The domain key to check. </value>
        [DataMember(Name = "domain_key", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as DomainKeyCheckRequest);
        }

        /// <summary>
        /// Returns true if DomainKeyCheckRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainKeyCheckRequest to be compared</param>
        /// <returns>Boolean</returns>

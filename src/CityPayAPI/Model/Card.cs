...
namespace CityPayAPI.Model
{
    ...
    public partial class Card : IValidatableObject
    {
        ...
        /// <param name="varDefault">Determines if the card is the default card for the account and should be regarded as the first option to be used for processing..</param>
        ...
        /// <example>Visa/0002,Exp:2304</example>

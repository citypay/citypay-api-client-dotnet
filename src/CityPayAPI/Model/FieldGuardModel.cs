...
namespace CityPayAPI.Model
{
    ...
    /// FieldGuardModel
    /// </summary>
    [DataContract(Name = "FieldGuardModel")]
    public partial class FieldGuardModel : IEquatable<FieldGuardModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldGuardModel" /> class.
        /// </summary>
        ...
        public FieldGuardModel(string label = default(string), string name = default(string), string type = default(string))
        {
            this.Label = label;
            this.Name = name;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FieldGuardModel {\n");
        ...
        {
            return this.Equals(input as FieldGuardModel);
        }

        /// <summary>
        /// Returns true if FieldGuardModel instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldGuardModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldGuardModel input)
        {
            if (input == null)
                return false;

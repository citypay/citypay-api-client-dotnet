...
namespace CityPayAPI.Model
{
    ...
    public partial class CheckBatchStatus : IEquatable<CheckBatchStatus>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CheckBatchStatus" /> class.
        /// </summary>
        /// <param name="accountId">The batch account id to obtain the batch for. Defaults to your client id if not provided..</param>
        /// <param name="batchId">The batch id to obtain the status for. (required).</param>
        public CheckBatchStatus(string accountId = default(string), int batchId = default(int))
        {
        ...
        /// </summary>
        /// <value>The batch id to obtain the status for.</value>

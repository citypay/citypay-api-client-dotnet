...
namespace CityPayAPI.Model
{
    ...
    /// DirectPostRequest
    /// </summary>
    [DataContract(Name = "DirectPostRequest")]
    public partial class DirectPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DirectPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectPostRequest" /> class.
        /// </summary>
        ...
        /// <param name="nonce">A random value Hex string (uppercase) which is provided to the API to perform a digest. The value will be used in any digest function. .</param>
        ...
        /// <param name="redirectSuccess">The URL used to redirect back to your site when a transaction has been tokenised or authorised. Required if a url-encoded request. .</param>
        ...
        public DirectPostRequest(int amount = default(int), string avsPostcodePolicy = default(string), ContactDetails billTo = default(ContactDetails), string cardnumber = default(string), string csc = default(string), string cscPolicy = default(string), string currency = default(string), string duplicatePolicy = default(string), int expmonth = default(int), int expyear = default(int), string identifier = default(string), string mac = default(string), string matchAvsa = default(string), string nameOnCard = default(string), string nonce = default(string), string redirectFailure = default(string), string redirectSuccess = default(string), ContactDetails shipTo = default(ContactDetails), List<string> tag = default(List<string>), ThreeDSecure threedsecure = default(ThreeDSecure), string transInfo = default(string), string transType = default(string))
        {
            this.Amount = amount;
            // to ensure "cardnumber" is required (not null)
            if (cardnumber == null)
            {
                throw new ArgumentNullException("cardnumber is a required property for DirectPostRequest and cannot be null");
            }
            ...
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for DirectPostRequest and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "mac" is required (not null)
            if (mac == null)
            {
                throw new ArgumentNullException("mac is a required property for DirectPostRequest and cannot be null");
            }
            this.Mac = mac;
        ...
        /// </summary>
        /// <value>A message authentication code ensures the data is authentic and that the intended amount has not been tampered with. The mac value is generated using a hash-based mac value. The following algorithm is used. - A key (k) is derived from your licence key - A value (v) is produced by concatenating the nonce, amount value and identifier, such as a purchase   with nonce &#x60;0123456789ABCDEF&#x60; an amount of £275.95 and an identifier of OD-12345678 would become   &#x60;0123456789ABCDEF27595OD-12345678&#x60; and extracting the UTF-8 byte values - The result from HMAC_SHA256(k, v) is hex-encoded (upper-case) - For instance, a licence key of &#x60;LK123456789&#x60;, a nonce of &#x60;0123456789ABCDEF&#x60;, an amount of &#x60;27595&#x60; and an identifier of &#x60;OD-12345678&#x60;  would generate a MAC of &#x60;163DBAB194D743866A9BCC7FC9C8A88FCD99C6BBBF08D619291212D1B91EE12E&#x60;. </value>
        /// <example>3896FBC43674AF59478DAF7F546FA4D4CB89981A936E6AAE997E43B55DF6C39D</example>
        ...
        /// </summary>
        /// <value>A random value Hex string (uppercase) which is provided to the API to perform a digest. The value will be used in any digest function. </value>
        ...
        /// </summary>
        /// <value>The URL used to redirect back to your site when a transaction has been tokenised or authorised. Required if a url-encoded request. </value>

...
namespace CityPayAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MerchantBatchReportResponse")]
    public partial class MerchantBatchReportResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantBatchReportResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MerchantBatchReportResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantBatchReportResponse" /> class.
        /// </summary>
        ...
        public MerchantBatchReportResponse(List<MerchantBatchResponse> batches = default(List<MerchantBatchResponse>), int count = default(int), int maxResults = default(int), string nextToken = default(string))
        {
            // to ensure "batches" is required (not null)
            if (batches == null)
            {
                throw new ArgumentNullException("batches is a required property for MerchantBatchReportResponse and cannot be null");
            }

...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkCart : IEquatable<PaylinkCart>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkCart);
        }

        /// <summary>
        /// Returns true if PaylinkCart instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkCart to be compared</param>
        /// <returns>Boolean</returns>

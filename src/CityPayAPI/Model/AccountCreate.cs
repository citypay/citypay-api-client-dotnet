...
namespace CityPayAPI.Model
{
    ...
    public partial class AccountCreate :  IEquatable<AccountCreate>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountId">A card holder account id used for uniquely identifying the account. This value will be used for future referencing of the account oand to link your system to this API. This value is immutable and never changes. .</param>

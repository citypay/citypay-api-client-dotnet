...
namespace CityPayAPI.Model
{
    ...
    public partial class ProcessBatchRequest : IValidatableObject
    {
        ...
        public ProcessBatchRequest(DateOnly batchDate = default(DateOnly), int batchId = default(int), string clientAccountId = default(string), List<BatchTransaction> transactions = default(List<BatchTransaction>))
        {
            // to ensure "batchDate" is required (not null)
            if (batchDate == null)
            {
                throw new ArgumentNullException("batchDate is a required property for ProcessBatchRequest and cannot be null");
            }

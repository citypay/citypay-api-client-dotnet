...
*OperationalAPIFunctions* | [**AclCheckRequest**](docs/OperationalAPIFunctions.md#aclcheckrequest) | **POST** /v6/acl/check | ACL Check Request
*OperationalAPIFunctions* | [**DomainKeyCheckRequest**](docs/OperationalAPIFunctions.md#domainkeycheckrequest) | **POST** /dk/check | Domain Key Check Request
*OperationalAPIFunctions* | [**DomainKeyGenRequest**](docs/OperationalAPIFunctions.md#domainkeygenrequest) | **POST** /dk/gen | Domain Key Generation Request
*OperationalAPIFunctions* | [**ListMerchantsRequest**](docs/OperationalAPIFunctions.md#listmerchantsrequest) | **GET** /v6/merchants/{clientid} | List Merchants Request
*OperationalAPIFunctions* | [**PingRequest**](docs/OperationalAPIFunctions.md#pingrequest) | **POST** /v6/ping | Ping Request

...
namespace CityPayAPI.Model
{
    ...
    public partial class UI : IEquatable<UI>, IValidatableObject
    {
        ...
        public UI(bool addressMandatory = default(bool), string formAutocomplete = default(string), ModelInt ordering = default(ModelInt), bool postcodeMandatory = default(bool))
        {
        ...
        public ModelInt Ordering { get; set; }

...
namespace CityPayAPI.Model
{
    ...
    public partial class InlineObject7 :  IEquatable<InlineObject7>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="retrieveRequest">retrieveRequest.</param>
        public InlineObject7(RetrieveRequest retrieveRequest = default(RetrieveRequest))
        {
            this.RetrieveRequest = retrieveRequest;
        }
        
        /// <summary>
        /// Gets or Sets RetrieveRequest
        /// </summary>
        [DataMember(Name="RetrieveRequest", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RetrieveRequest: ").Append(RetrieveRequest).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineObject7 input)
        {
            ...
            return 
                (
                    this.RetrieveRequest == input.RetrieveRequest ||
                    (this.RetrieveRequest != null &&
                    this.RetrieveRequest.Equals(input.RetrieveRequest))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RetrieveRequest != null)
                    hashCode = hashCode * 59 + this.RetrieveRequest.GetHashCode();
                return hashCode;
            }
        }

...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkUI : IEquatable<PaylinkUI>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkUI);
        }

        /// <summary>
        /// Returns true if PaylinkUI instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkUI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaylinkUI input)
        {
            if (input == null)
            {
                return false;

...
namespace CityPayAPI.Api
{
    ...
    public interface ICardHolderAccountApiSync : IApiAccessor
    {
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <param name="cardId">The id of the card that is presented by a call to retrieve a card holder account.</param>
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>Acknowledgement</returns>
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>ApiResponse of Acknowledgement</returns>
        ApiResponse<Acknowledgement> AccountCardStatusRequestWithHttpInfo (string accountid, string cardId, string status);
        /// <summary>
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>ApiResponse of Acknowledgement</returns>
        ApiResponse<Acknowledgement> AccountStatusRequestWithHttpInfo (string accountid);
        /// <summary>
        /// Charge
        /// </summary>
        /// <remarks>
    ...
    public interface ICardHolderAccountApiAsync : IApiAccessor
    {
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>Task of Acknowledgement</returns>
        System.Threading.Tasks.Task<Acknowledgement> AccountCardStatusRequestAsync (string accountid, string cardId, string status);
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>Task of ApiResponse (Acknowledgement)</returns>
        System.Threading.Tasks.Task<ApiResponse<Acknowledgement>> AccountCardStatusRequestAsyncWithHttpInfo (string accountid, string cardId, string status);
        /// <summary>
        /// Contact Details Update
        /// </summary>
        /// <remarks>
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>Task of Acknowledgement</returns>
        System.Threading.Tasks.Task<Acknowledgement> AccountStatusRequestAsync (string accountid);
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>Task of ApiResponse (Acknowledgement)</returns>
        System.Threading.Tasks.Task<ApiResponse<Acknowledgement>> AccountStatusRequestAsyncWithHttpInfo (string accountid);
        /// <summary>
        /// Charge
        /// </summary>
        /// <remarks>
    ...
    public partial class CardHolderAccountApi : ICardHolderAccountApi
    {
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>Acknowledgement</returns>
        public Acknowledgement AccountCardStatusRequest (string accountid, string cardId, string status)
        {
             CityPayAPI.Client.ApiResponse<Acknowledgement> localVarResponse = AccountCardStatusRequestWithHttpInfo(accountid, cardId, status);
             return localVarResponse.Data;
        }
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>ApiResponse of Acknowledgement</returns>
        public CityPayAPI.Client.ApiResponse< Acknowledgement > AccountCardStatusRequestWithHttpInfo (string accountid, string cardId, string status)
        {
            // verify the required parameter 'accountid' is set
            if (accountid == null)
            ...
            if (status == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'status' when calling CardHolderAccountApi->AccountCardStatusRequest");
            ...
            localVarRequestOptions.PathParameters.Add("accountid", CityPayAPI.Client.ClientUtils.ParameterToString(accountid)); // path parameter
            localVarRequestOptions.PathParameters.Add("cardId", CityPayAPI.Client.ClientUtils.ParameterToString(cardId)); // path parameter
            localVarRequestOptions.PathParameters.Add("status", CityPayAPI.Client.ClientUtils.ParameterToString(status)); // path parameter
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post< Acknowledgement >("/account/{accountid}/card/{cardId}/status/{status}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>Task of Acknowledgement</returns>
        public async System.Threading.Tasks.Task<Acknowledgement> AccountCardStatusRequestAsync (string accountid, string cardId, string status)
        {
             CityPayAPI.Client.ApiResponse<Acknowledgement> localVarResponse = await AccountCardStatusRequestAsyncWithHttpInfo(accountid, cardId, status);
             return localVarResponse.Data;
        ...
        /// <param name="status">The status of the card to set, valid values are &#x60;ACTIVE&#x60; or &#x60;INACTIVE&#x60;.</param>
        /// <returns>Task of ApiResponse (Acknowledgement)</returns>
        public async System.Threading.Tasks.Task<CityPayAPI.Client.ApiResponse<Acknowledgement>> AccountCardStatusRequestAsyncWithHttpInfo (string accountid, string cardId, string status)
        {
            // verify the required parameter 'accountid' is set
            if (accountid == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'accountid' when calling CardHolderAccountApi->AccountCardStatusRequest");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Acknowledgement>("/account/{accountid}/card/{cardId}/status/{status}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>Acknowledgement</returns>
        public Acknowledgement AccountStatusRequest (string accountid)
        {
             CityPayAPI.Client.ApiResponse<Acknowledgement> localVarResponse = AccountStatusRequestWithHttpInfo(accountid);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>ApiResponse of Acknowledgement</returns>
        public CityPayAPI.Client.ApiResponse< Acknowledgement > AccountStatusRequestWithHttpInfo (string accountid)
        {
            // verify the required parameter 'accountid' is set
            if (accountid == null)
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>Task of Acknowledgement</returns>
        public async System.Threading.Tasks.Task<Acknowledgement> AccountStatusRequestAsync (string accountid)
        {
             CityPayAPI.Client.ApiResponse<Acknowledgement> localVarResponse = await AccountStatusRequestAsyncWithHttpInfo(accountid);
             return localVarResponse.Data;
        ...
        /// <param name="accountid">The account id that refers to the customer&#39;s account no. This value will have been provided when setting up the card holder account.</param>
        /// <returns>Task of ApiResponse (Acknowledgement)</returns>
        public async System.Threading.Tasks.Task<CityPayAPI.Client.ApiResponse<Acknowledgement>> AccountStatusRequestAsyncWithHttpInfo (string accountid)
        {
            // verify the required parameter 'accountid' is set
            if (accountid == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'accountid' when calling CardHolderAccountApi->AccountStatusRequest");

...
namespace CityPayAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemittanceReportRequest")]
    public partial class RemittanceReportRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemittanceReportRequest" /> class.
        /// </summary>
        ...
        /// <param name="orderBy">Specifies the field by which results are ordered. Available fields are [trans_no,date_when,amount]. By default, fields are ordered by OrderByExpression(trans_no,ASC). To order in descending order, prefix with &#39;-&#39; or suffix with &#39; DESC&#39;..</param>
        public RemittanceReportRequest(DateOnly dateFrom = default(DateOnly), DateOnly dateUntil = default(DateOnly), int maxResults = default(int), List<int> merchantId = default(List<int>), string nextToken = default(string), string orderBy = default(string))
        {
        ...
        /// </summary>
        /// <value>Specifies the field by which results are ordered. Available fields are [trans_no,date_when,amount]. By default, fields are ordered by OrderByExpression(trans_no,ASC). To order in descending order, prefix with &#39;-&#39; or suffix with &#39; DESC&#39;.</value>

...
namespace CityPayAPI.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public InlineObject4(AccountCreate accountCreate = default(AccountCreate))
        {
            this.AccountCreate = accountCreate;
        }
        
        /// <summary>
        /// Gets or Sets AccountCreate
        /// </summary>
        [DataMember(Name="AccountCreate", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccountCreate: ").Append(AccountCreate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineObject4 input)
        {
            ...
            return 
                (
                    this.AccountCreate == input.AccountCreate ||
                    (this.AccountCreate != null &&
                    this.AccountCreate.Equals(input.AccountCreate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccountCreate != null)
                    hashCode = hashCode * 59 + this.AccountCreate.GetHashCode();
                return hashCode;
            }
        }

...
namespace CityPayAPI.Model
{
    ...
    public partial class Address : IEquatable<Address>, IValidatableObject
    {
        ...
        /// <param name="aDDRESSLABEL">A label for the address such as Head Office, Home Address..</param>
        ...
        public Address(string address1 = default(string), string address2 = default(string), string address3 = default(string), string aDDRESSLABEL = default(string), string area = default(string), string country = default(string), string postcode = default(string))
        {
            this.Address1 = address1;
            this.Address2 = address2;
            this.Address3 = address3;
            this.ADDRESS_LABEL = aDDRESSLABEL;
            this.Area = area;
        ...
        [DataMember(Name = "ADDRESS_LABEL", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ADDRESS_LABEL: ").Append(ADDRESS_LABEL).Append("\n");
        ...
        public bool Equals(Address input)
        {
            ...
            return 
                ...
                (
                    this.ADDRESS_LABEL == input.ADDRESS_LABEL ||
                    (this.ADDRESS_LABEL != null &&
                    this.ADDRESS_LABEL.Equals(input.ADDRESS_LABEL))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ADDRESS_LABEL != null)
                    hashCode = hashCode * 59 + this.ADDRESS_LABEL.GetHashCode();
                if (this.Area != null)
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // ADDRESS_LABEL (string) maxLength
            if(this.ADDRESS_LABEL != null && this.ADDRESS_LABEL.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ADDRESS_LABEL, length must be less than 20.", new [] { "ADDRESS_LABEL" });
            }

            // ADDRESS_LABEL (string) minLength
            if(this.ADDRESS_LABEL != null && this.ADDRESS_LABEL.Length < 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ADDRESS_LABEL, length must be greater than 2.", new [] { "ADDRESS_LABEL" });
            }

...
namespace CityPayAPI.Model
{
    ...
    public partial class ThreeDSecure : IValidatableObject
    {
        ...
        /// <param name="browserColorDepth">BrowserColorDepth field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        /// <param name="browserIP">BrowserIP field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        /// <param name="browserJavaEnabled">BrowserJavaEnabled field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        /// <param name="browserLanguage">BrowserLanguage field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        /// <param name="browserScreenHeight">BrowserScreenHeight field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        /// <param name="browserScreenWidth">BrowserScreenWidth field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        /// <param name="browserTZ">BrowserTZ offset field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value..</param>
        ...
        public ThreeDSecure(string acceptHeaders = default(string), string browserColorDepth = default(string), string browserIP = default(string), string browserJavaEnabled = default(string), string browserLanguage = default(string), string browserScreenHeight = default(string), string browserScreenWidth = default(string), string browserTZ = default(string), string cpBx = default(string), bool downgrade1 = default(bool), string merchantTermurl = default(string), string tdsPolicy = default(string), string userAgent = default(string))
        {
        ...
        /// <example>text/html,application/xhtml+xml,application/xml;q&#x3D;0.9,image/webp,image/apng,*/*;q&#x3D;0.8,application/signed-exchange;v&#x3D;b3;q&#x3D;0.9</example>
        ...
        /// </summary>
        /// <value>BrowserColorDepth field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        ...
        /// </summary>
        /// <value>BrowserIP field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        [DataMember(Name = "browserIP", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>BrowserJavaEnabled field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        [DataMember(Name = "browserJavaEnabled", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>BrowserLanguage field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        [DataMember(Name = "browserLanguage", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>BrowserScreenHeight field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        ...
        /// </summary>
        /// <value>BrowserScreenWidth field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        ...
        /// </summary>
        /// <value>BrowserTZ offset field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the &#x60;bx&#x60; function to gather this value.</value>
        ...
        /// <example>FjaW50b3NoOyBJbnRlbCBNYWMgT1MgWCAx...</example>
        ...
        /// <example>https://mysite.com/acs/return</example>
        ...
        /// <example>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36</example>

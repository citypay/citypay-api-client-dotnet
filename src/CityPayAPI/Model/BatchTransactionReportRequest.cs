...
namespace CityPayAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchTransactionReportRequest")]
    public partial class BatchTransactionReportRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchTransactionReportRequest" /> class.
        /// </summary>
        ...
        public BatchTransactionReportRequest(int maxResults = default(int), string nextToken = default(string), string orderBy = default(string))
        {

...
namespace CityPayAPI.Model
{
    ...
    public partial class AuthRequest :  IEquatable<AuthRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>An optional reference value for the calling client such as a version number i.e.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.TransType != null && this.TransType.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TransType, length must be greater than 1.", new [] { "TransType" });
            }

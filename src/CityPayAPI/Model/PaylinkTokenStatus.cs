...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkTokenStatus : IEquatable<PaylinkTokenStatus>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkTokenStatus);
        }

        /// <summary>
        /// Returns true if PaylinkTokenStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkTokenStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaylinkTokenStatus input)
        {
            ...
            return 
                ...
                (
                    this.IsCustomerReceiptEmailSent == input.IsCustomerReceiptEmailSent ||
                    this.IsCustomerReceiptEmailSent.Equals(input.IsCustomerReceiptEmailSent)
                ) && 
                (
                ...
                (
                    this.IsMerchantNotificationEmailSent == input.IsMerchantNotificationEmailSent ||
                    this.IsMerchantNotificationEmailSent.Equals(input.IsMerchantNotificationEmailSent)
                ) && 
                (
                ...
                (
                    this.IsRequestChallenged == input.IsRequestChallenged ||
                    this.IsRequestChallenged.Equals(input.IsRequestChallenged)
                ) && 
                (
                ...
                (
                    this.PaymentAttemptsCount == input.PaymentAttemptsCount ||
                    this.PaymentAttemptsCount.Equals(input.PaymentAttemptsCount)
                ) && 
                (

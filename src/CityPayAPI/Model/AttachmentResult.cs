...
namespace CityPayAPI.Model
{
    ...
    /// AttachmentResult
    /// </summary>
    [DataContract(Name = "AttachmentResult")]
    public partial class AttachmentResult : IEquatable<AttachmentResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachmentResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentResult" /> class.
        /// </summary>
        ...
        public AttachmentResult(string name = default(string), string result = default(string), string url = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for AttachmentResult and cannot be null");
            // to ensure "result" is required (not null)
            this.Result = result ?? throw new ArgumentNullException("result is a required property for AttachmentResult and cannot be null");
            this.Url = url;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttachmentResult {\n");
        ...
        {
            return this.Equals(input as AttachmentResult);
        }

        /// <summary>
        /// Returns true if AttachmentResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentResult input)
        {
            if (input == null)
                return false;

# CityPayAPI.Api.CardHolderAccountAPIApi

All URIs are relative to *https://api.citypay.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**AccountCardDeleteRequest**](CardHolderAccountAPIApi.md#accountcarddeleterequest) | **DELETE** /v6/account/{accountid}/card/{cardId} | Card Deletion
[**AccountCardRegisterRequest**](CardHolderAccountAPIApi.md#accountcardregisterrequest) | **POST** /v6/account/{accountid}/register | Card Registration
[**AccountCardStatusRequest**](CardHolderAccountAPIApi.md#accountcardstatusrequest) | **POST** /v6/account/{accountid}/card/{cardId}/status | Card Status
[**AccountChangeContactRequest**](CardHolderAccountAPIApi.md#accountchangecontactrequest) | **POST** /v6/account/{accountid}/contact | Contact Details Update
[**AccountCreate**](CardHolderAccountAPIApi.md#accountcreate) | **POST** /v6/account/create | Account Create
[**AccountDeleteRequest**](CardHolderAccountAPIApi.md#accountdeleterequest) | **DELETE** /v6/account/{accountid} | Account Deletion
[**AccountExistsRequest**](CardHolderAccountAPIApi.md#accountexistsrequest) | **GET** /v6/account-exists/{accountid} | Account Exists
[**AccountRetrieveRequest**](CardHolderAccountAPIApi.md#accountretrieverequest) | **GET** /v6/account/{accountid} | Account Retrieval
[**AccountStatusRequest**](CardHolderAccountAPIApi.md#accountstatusrequest) | **POST** /v6/account/{accountid}/status | Account Status
[**ChargeRequest**](CardHolderAccountAPIApi.md#chargerequest) | **POST** /v6/charge | Charge
...
namespace Example
{
    public class AccountCardDeleteRequestExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CardHolderAccountAPIApi(config);
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountCardDeleteRequest: " + e.Message );
...
namespace Example
{
    public class AccountCardRegisterRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountCardRegisterRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountCardStatusRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountCardStatusRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountChangeContactRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountChangeContactRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountCreateExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountCreate: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountDeleteRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountDeleteRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountExistsRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountExistsRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountRetrieveRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountRetrieveRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class AccountStatusRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.AccountStatusRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
namespace Example
{
    public class ChargeRequestExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CardHolderAccountAPIApi.ChargeRequest: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }

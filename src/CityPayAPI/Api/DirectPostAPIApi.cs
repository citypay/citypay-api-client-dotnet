    ...
    public partial class DirectPostAPIApi : IDirectPostAPIApi
    {
        ...
        public CityPayAPI.Client.ApiResponse<AuthResponse> DirectPostAuthRequestWithHttpInfo(DirectPostRequest directPostRequest)
        {
            ...
            if (directPostRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'directPostRequest' when calling DirectPostAPIApi->DirectPostAuthRequest");
        ...
        public CityPayAPI.Client.ApiResponse<AuthResponse> DirectPostTokeniseRequestWithHttpInfo(DirectPostRequest directPostRequest)
        {
            // verify the required parameter 'directPostRequest' is set
            if (directPostRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'directPostRequest' when calling DirectPostAPIApi->DirectPostTokeniseRequest");
        ...
        public CityPayAPI.Client.ApiResponse<AuthResponse> TokenRequestWithHttpInfo(DirectTokenAuthRequest directTokenAuthRequest)
        {
            ...
            if (directTokenAuthRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'directTokenAuthRequest' when calling DirectPostAPIApi->TokenRequest");

...
namespace CityPayAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListMerchantsResponse")]
    public partial class ListMerchantsResponse : IEquatable<ListMerchantsResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="clientName">The client name that was requested..</param>
        /// <param name="clientid">The client id requested..</param>
        /// <param name="merchants">merchants.</param>
        public ListMerchantsResponse(string clientName = default(string), string clientid = default(string), List<Merchant> merchants = default(List<Merchant>))
        {
        ...
        /// </summary>
        /// <value>The client name that was requested.</value>
        ...
        /// </summary>
        /// <value>The client id requested.</value>
        ...
        {
            return this.Equals(input as ListMerchantsResponse);
        }

        /// <summary>
        /// Returns true if ListMerchantsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListMerchantsResponse to be compared</param>
        /// <returns>Boolean</returns>

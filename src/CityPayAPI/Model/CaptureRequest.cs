...
namespace CityPayAPI.Model
{
    ...
    public partial class CaptureRequest :  IEquatable<CaptureRequest>, IValidatableObject
    {
        ...
        public CaptureRequest(AirlineAdvice airlineData = default(AirlineAdvice), int amount = default(int), string identifier = default(string), int merchantid = default(int), string sdk = default(string), int transno = default(int))
        {

...
namespace CityPayAPI.Model
{
    ...
    public partial class ChargeRequest : IValidatableObject
    {
        ...
        public ChargeRequest(int amount = default(int), string avsPostcodePolicy = default(string), string cardholderAgreement = default(string), string csc = default(string), string cscPolicy = default(string), string currency = default(string), string duplicatePolicy = default(string), string identifier = default(string), string initiation = default(string), string matchAvsa = default(string), int merchantid = default(int), List<string> tag = default(List<string>), ThreeDSecure threedsecure = default(ThreeDSecure), string token = default(string), string transInfo = default(string), string transType = default(string))
        {
            ...
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for ChargeRequest and cannot be null");
            }
            this.Token = token;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for CardholderAgreement, length must be less than 1.", new [] { "CardholderAgreement" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Initiation, length must be less than 1.", new [] { "Initiation" });
            }

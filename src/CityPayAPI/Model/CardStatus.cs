...
namespace CityPayAPI.Model
{
    ...
    public partial class CardStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardStatus" /> class.
        /// </summary>
        /// <param name="varCardStatus">The status of the card to set, valid values are ACTIVE or INACTIVE..</param>
        /// <param name="varDefault">Defines if the card is set as the default..</param>
        public CardStatus(string varCardStatus = default(string), bool varDefault = default(bool))
        {
            this.VarCardStatus = varCardStatus;
        ...
        public string VarCardStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarCardStatus: ").Append(VarCardStatus).Append("\n");

...
namespace CityPayAPI.Model
{
    ...
    /// AuthReferences
    /// </summary>
    [DataContract(Name = "AuthReferences")]
    public partial class AuthReferences : IEquatable<AuthReferences>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthReferences);
        }

        /// <summary>
        /// Returns true if AuthReferences instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthReferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthReferences input)
        {
            if (input == null)
                return false;

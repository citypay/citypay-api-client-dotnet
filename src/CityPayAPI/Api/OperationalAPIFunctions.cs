...
namespace CityPayAPI.Api
{
    ...
    /// </summary>
    public interface IOperationalAPIFunctionsSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IOperationalAPIFunctionsAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IOperationalAPIFunctions : IOperationalAPIFunctionsSync, IOperationalAPIFunctionsAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class OperationalAPIFunctions : IOperationalAPIFunctions
    {
        private CityPayAPI.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalAPIFunctions"/> class.
        /// </summary>
        /// <returns></returns>
        public OperationalAPIFunctions() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public OperationalAPIFunctions(string basePath)
        {
        ...
        /// <returns></returns>
        public OperationalAPIFunctions(CityPayAPI.Client.Configuration configuration)
        {
        ...
        public OperationalAPIFunctions(CityPayAPI.Client.ISynchronousClient client, CityPayAPI.Client.IAsynchronousClient asyncClient, CityPayAPI.Client.IReadableConfiguration configuration)
        {
        ...
        public CityPayAPI.Client.ApiResponse<AclCheckResponseModel> AclCheckRequestWithHttpInfo(AclCheckRequest aclCheckRequest)
        {
            ...
            if (aclCheckRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'aclCheckRequest' when calling OperationalAPIFunctions->AclCheckRequest");
        ...
        public CityPayAPI.Client.ApiResponse<DomainKeyResponse> DomainKeyCheckRequestWithHttpInfo(DomainKeyCheckRequest domainKeyCheckRequest)
        {
            ...
            if (domainKeyCheckRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'domainKeyCheckRequest' when calling OperationalAPIFunctions->DomainKeyCheckRequest");
        ...
        public CityPayAPI.Client.ApiResponse<DomainKeyResponse> DomainKeyGenRequestWithHttpInfo(DomainKeyRequest domainKeyRequest)
        {
            ...
            if (domainKeyRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'domainKeyRequest' when calling OperationalAPIFunctions->DomainKeyGenRequest");
        ...
        public CityPayAPI.Client.ApiResponse<ListMerchantsResponse> ListMerchantsRequestWithHttpInfo(string clientid)
        {
            ...
            if (clientid == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'clientid' when calling OperationalAPIFunctions->ListMerchantsRequest");
        ...
        public CityPayAPI.Client.ApiResponse<Acknowledgement> PingRequestWithHttpInfo(Ping ping)
        {
            ...
            if (ping == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'ping' when calling OperationalAPIFunctions->PingRequest");

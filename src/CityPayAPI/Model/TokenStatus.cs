...
namespace CityPayAPI.Model
{
    ...
    public partial class TokenStatus : IEquatable<TokenStatus>, IValidatableObject
    {
        ...
        public TokenStatus(int amountPaid = default(int), string authCode = default(string), string card = default(string), DateTime created = default(DateTime), DateTime datetime = default(DateTime), string identifier = default(string), bool isAccessGuarded = default(bool), bool isAttachment = default(bool), bool isCancelled = default(bool), bool isEmailSent = default(bool), bool isExpired = default(bool), bool isFormViewed = default(bool), bool isOpenForPayment = default(bool), bool isPaid = default(bool), bool isPaymentAttempted = default(bool), bool isPostbackOk = default(bool), bool isSMSSent = default(bool), bool isValidated = default(bool), DateTime lastEventDateTime = default(DateTime), string lastPaymentResult = default(string), string mid = default(string), List<StateEvent> stateHistory = default(List<StateEvent>), string token = default(string), int transNo = default(int), string url = default(string), string urlShortCode = default(string))
        {

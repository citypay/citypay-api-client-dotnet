...
namespace CityPayAPI.Model
{
    ...
    public partial class EmailNotificationPath : IEquatable<EmailNotificationPath>, IValidatableObject
    {
        ...
        public EmailNotificationPath(string bcc = default(string), string cc = default(string), string replyTo = default(string), string template = default(string), string to = default(string))
        {

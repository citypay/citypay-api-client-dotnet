...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkTokenCreated : IEquatable<PaylinkTokenCreated>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaylinkTokenCreated);
        }

        /// <summary>
        /// Returns true if PaylinkTokenCreated instances are equal
        /// </summary>
        /// <param name="input">Instance of PaylinkTokenCreated to be compared</param>
        /// <returns>Boolean</returns>

...
namespace CityPayAPI.Api
{
    ...
    public interface IBatchProcessingApiSync : IApiAccessor
    {
        ...
        ApiResponse<BatchReportResponseModel> GetBatchReportRequestWithHttpInfo(BatchReportRequest batchReportRequest);
    ...
    public interface IBatchProcessingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BatchReportResponseModel> GetBatchReportRequestAsync(BatchReportRequest batchReportRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BatchReportResponseModel>> GetBatchReportRequestWithHttpInfoAsync(BatchReportRequest batchReportRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BatchProcessingApi : IBatchProcessingApi
    {
        ...
        public CityPayAPI.Client.ApiResponse<ProcessBatchResponse> BatchProcessRequestWithHttpInfo(ProcessBatchRequest processBatchRequest)
        {
            ...
            var localVarResponse = this.Client.Post<ProcessBatchResponse>("/batch/process", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<CityPayAPI.Client.ApiResponse<ProcessBatchResponse>> BatchProcessRequestWithHttpInfoAsync(ProcessBatchRequest processBatchRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ProcessBatchResponse>("/batch/process", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public CityPayAPI.Client.ApiResponse<CheckBatchStatusResponse> CheckBatchStatusRequestWithHttpInfo(CheckBatchStatus checkBatchStatus)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<CheckBatchStatusResponse>("/batch/status", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<CityPayAPI.Client.ApiResponse<CheckBatchStatusResponse>> CheckBatchStatusRequestWithHttpInfoAsync(CheckBatchStatus checkBatchStatus, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<CheckBatchStatusResponse>("/batch/status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="batchReportRequest"></param>
        /// <returns>BatchReportResponseModel</returns>
        public BatchReportResponseModel GetBatchReportRequest(BatchReportRequest batchReportRequest)
        {
            CityPayAPI.Client.ApiResponse<BatchReportResponseModel> localVarResponse = GetBatchReportRequestWithHttpInfo(batchReportRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="batchReportRequest"></param>
        /// <returns>ApiResponse of BatchReportResponseModel</returns>
        public CityPayAPI.Client.ApiResponse<BatchReportResponseModel> GetBatchReportRequestWithHttpInfo(BatchReportRequest batchReportRequest)
        {
            // verify the required parameter 'batchReportRequest' is set
            if (batchReportRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'batchReportRequest' when calling BatchProcessingApi->GetBatchReportRequest");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<BatchReportResponseModel>("/batch/retrieve", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBatchReportRequest", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BatchReportResponseModel</returns>
        public async System.Threading.Tasks.Task<BatchReportResponseModel> GetBatchReportRequestAsync(BatchReportRequest batchReportRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            CityPayAPI.Client.ApiResponse<BatchReportResponseModel> localVarResponse = await GetBatchReportRequestWithHttpInfoAsync(batchReportRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchReportResponseModel)</returns>
        public async System.Threading.Tasks.Task<CityPayAPI.Client.ApiResponse<BatchReportResponseModel>> GetBatchReportRequestWithHttpInfoAsync(BatchReportRequest batchReportRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'batchReportRequest' is set
            if (batchReportRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'batchReportRequest' when calling BatchProcessingApi->GetBatchReportRequest");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<BatchReportResponseModel>("/batch/retrieve", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

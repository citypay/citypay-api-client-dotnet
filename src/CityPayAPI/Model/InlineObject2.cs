...
namespace CityPayAPI.Model
{
    ...
    public partial class InlineObject2 :  IEquatable<InlineObject2>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="captureRequest">captureRequest.</param>
        public InlineObject2(CaptureRequest captureRequest = default(CaptureRequest))
        {
            this.CaptureRequest = captureRequest;
        }
        
        /// <summary>
        /// Gets or Sets CaptureRequest
        /// </summary>
        [DataMember(Name="CaptureRequest", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CaptureRequest: ").Append(CaptureRequest).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineObject2 input)
        {
            ...
            return 
                (
                    this.CaptureRequest == input.CaptureRequest ||
                    (this.CaptureRequest != null &&
                    this.CaptureRequest.Equals(input.CaptureRequest))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CaptureRequest != null)
                    hashCode = hashCode * 59 + this.CaptureRequest.GetHashCode();
                return hashCode;
            }
        }

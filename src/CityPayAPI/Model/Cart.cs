...
namespace CityPayAPI.Model
{
    ...
    public partial class Cart : IEquatable<Cart>, IValidatableObject
    {
        ...
        public Cart(string contents = default(string), string coupon = default(string), int mode = default(int), string productDescription = default(string), string productInformation = default(string), int shipping = default(int), int tax = default(int))
        {

...
namespace CityPayAPI.Model
{
    ...
    public partial class Card :  IEquatable<Card>, IValidatableObject
    {
        ...
        /// <param name="defaultCard">Determines if the card is the default card for the account and should be regarded as the first option to be used for processing..</param>
        ...
        public Card(bool binCommercial = default(bool), bool binCorporate = default(bool), string binCountryIssued = default(string), bool binCredit = default(bool), string binCurrency = default(string), bool binDebit = default(bool), string binDescription = default(string), bool binEu = default(bool), string cardId = default(string), string cardStatus = default(string), bool defaultCard = default(bool), int expmonth = default(int), int expyear = default(int), string label = default(string), string label2 = default(string), string last4digits = default(string), string scheme = default(string), string token = default(string))
        {

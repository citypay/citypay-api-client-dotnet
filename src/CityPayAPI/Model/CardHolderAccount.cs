...
namespace CityPayAPI.Model
{
    ...
    public partial class CardHolderAccount :  IEquatable<CardHolderAccount>, IValidatableObject
    {
        ...
        public CardHolderAccount(string accountId = default(string), List<Card> cards = default(List<Card>), ContactDetails contact = default(ContactDetails), DateTime dateCreated = default(DateTime), string defaultCardId = default(string), string defaultCardIndex = default(string), string status = default(string), string uniqueId = default(string))
        {
        ...
        public string DefaultCardIndex { get; set; }

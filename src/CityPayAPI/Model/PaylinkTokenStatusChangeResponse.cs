...
namespace CityPayAPI.Model
{
    ...
    public partial class PaylinkTokenStatusChangeResponse : IValidatableObject
    {
        /// <summary>
        ...
        public PaylinkTokenStatusChangeResponse(int count = default(int), int maxResults = default(int), string nextToken = default(string), List<PaylinkTokenStatus> tokens = default(List<PaylinkTokenStatus>))
        {

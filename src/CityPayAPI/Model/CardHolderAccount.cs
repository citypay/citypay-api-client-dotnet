...
namespace CityPayAPI.Model
{
    ...
    public partial class CardHolderAccount :  IEquatable<CardHolderAccount>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CardHolderAccount" /> class.
        /// </summary>
        /// <param name="accountId">The account id of the card holder account which uniquely identifies the account.  (required).</param>
        /// <param name="cacId">The card holder control id which identifies the scheme that the account belongs to, ordinarily this is the same as your client id..</param>
        /// <param name="cards">cards.</param>
        /// <param name="contact">contact (required).</param>
        /// <param name="dateCreated">The date and time the account was created..</param>
        /// <param name="transStatus">Defines the status of the account for processing valid values are   - ACTIVE for active accounts that are able to process  - DISABLED for accounts that are currently disabled for processing. .</param>
        public CardHolderAccount(string accountId = default(string), string cacId = default(string), List<Card> cards = default(List<Card>), ContactDetails contact = default(ContactDetails), DateTime dateCreated = default(DateTime), string transStatus = default(string))
        {
        ...
        /// </summary>
        /// <value>The account id of the card holder account which uniquely identifies the account. </value>
        [DataMember(Name="account_id", EmitDefaultValue=false)]
        public string AccountId { get; set; }

        /// <summary>
        /// The card holder control id which identifies the scheme that the account belongs to, ordinarily this is the same as your client id.
        /// </summary>
        /// <value>The card holder control id which identifies the scheme that the account belongs to, ordinarily this is the same as your client id.</value>
        [DataMember(Name="cac_id", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CacId: ").Append(CacId).Append("\n");
        ...
        public bool Equals(CardHolderAccount input)
        {
            ...
            return 
                ...
                (
                    this.CacId == input.CacId ||
                    (this.CacId != null &&
                    this.CacId.Equals(input.CacId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CacId != null)
                    hashCode = hashCode * 59 + this.CacId.GetHashCode();
                if (this.Cards != null)
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CacId (string) maxLength
            if(this.CacId != null && this.CacId.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CacId, length must be less than 20.", new [] { "CacId" });
            }

            // CacId (string) minLength
            if(this.CacId != null && this.CacId.Length < 5)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CacId, length must be greater than 5.", new [] { "CacId" });
            }

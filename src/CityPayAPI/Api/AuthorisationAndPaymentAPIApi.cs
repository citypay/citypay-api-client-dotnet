...
namespace CityPayAPI.Api
{
    ...
    /// </summary>
    public interface IAuthorisationAndPaymentAPIApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAuthorisationAndPaymentAPIApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAuthorisationAndPaymentAPIApi : IAuthorisationAndPaymentAPIApiSync, IAuthorisationAndPaymentAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AuthorisationAndPaymentAPIApi : IAuthorisationAndPaymentAPIApi
    {
        private CityPayAPI.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorisationAndPaymentAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AuthorisationAndPaymentAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AuthorisationAndPaymentAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public AuthorisationAndPaymentAPIApi(CityPayAPI.Client.Configuration configuration)
        {
        ...
        public AuthorisationAndPaymentAPIApi(CityPayAPI.Client.ISynchronousClient client, CityPayAPI.Client.IAsynchronousClient asyncClient, CityPayAPI.Client.IReadableConfiguration configuration)
        {
        ...
        public CityPayAPI.Client.ApiResponse<Decision> AuthorisationRequestWithHttpInfo(AuthRequest authRequest)
        {
            ...
            if (authRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'authRequest' when calling AuthorisationAndPaymentAPIApi->AuthorisationRequest");
        ...
        public CityPayAPI.Client.ApiResponse<Bin> BinRangeLookupRequestWithHttpInfo(BinLookup binLookup)
        {
            ...
            if (binLookup == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'binLookup' when calling AuthorisationAndPaymentAPIApi->BinRangeLookupRequest");
        ...
        public CityPayAPI.Client.ApiResponse<AuthResponse> CResRequestWithHttpInfo(CResAuthRequest cResAuthRequest)
        {
            ...
            if (cResAuthRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'cResAuthRequest' when calling AuthorisationAndPaymentAPIApi->CResRequest");
        ...
        public CityPayAPI.Client.ApiResponse<Acknowledgement> CaptureRequestWithHttpInfo(CaptureRequest captureRequest)
        {
            ...
            if (captureRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'captureRequest' when calling AuthorisationAndPaymentAPIApi->CaptureRequest");
        ...
        public CityPayAPI.Client.ApiResponse<AuthResponse> PaResRequestWithHttpInfo(PaResAuthRequest paResAuthRequest)
        {
            ...
            if (paResAuthRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'paResAuthRequest' when calling AuthorisationAndPaymentAPIApi->PaResRequest");
        ...
        public CityPayAPI.Client.ApiResponse<AuthResponse> RefundRequestWithHttpInfo(RefundRequest refundRequest)
        {
            ...
            if (refundRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'refundRequest' when calling AuthorisationAndPaymentAPIApi->RefundRequest");
        ...
        public CityPayAPI.Client.ApiResponse<AuthReferences> RetrievalRequestWithHttpInfo(RetrieveRequest retrieveRequest)
        {
            ...
            if (retrieveRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'retrieveRequest' when calling AuthorisationAndPaymentAPIApi->RetrievalRequest");
        ...
        public CityPayAPI.Client.ApiResponse<Acknowledgement> VoidRequestWithHttpInfo(VoidRequest voidRequest)
        {
            ...
            if (voidRequest == null)
                throw new CityPayAPI.Client.ApiException(400, "Missing required parameter 'voidRequest' when calling AuthorisationAndPaymentAPIApi->VoidRequest");

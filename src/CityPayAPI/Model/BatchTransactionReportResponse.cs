...
namespace CityPayAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchTransactionReportResponse")]
    public partial class BatchTransactionReportResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchTransactionReportResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchTransactionReportResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchTransactionReportResponse" /> class.
        /// </summary>
        ...
        public BatchTransactionReportResponse(int count = default(int), List<AuthReference> data = default(List<AuthReference>), int maxResults = default(int), string nextToken = default(string))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for BatchTransactionReportResponse and cannot be null");
            }
            this.Data = data;
            this.Count = count;
        ...
        public List<AuthReference> Data { get; set; }

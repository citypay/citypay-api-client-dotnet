...
namespace CityPayAPI.Model
{
    ...
    public partial class ProcessBatchRequest : IEquatable<ProcessBatchRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ProcessBatchRequest" /> class.
        /// </summary>
        /// <param name="accountId">The batch account id to process the batch for. Defaults to your client id if not provided..</param>
        ...
        public ProcessBatchRequest(string accountId = default(string), DateTime batchDate = default(DateTime), int batchId = default(int), List<BatchTransaction> transactions = default(List<BatchTransaction>))
        {

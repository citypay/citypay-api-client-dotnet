...
namespace CityPayAPI.Model
{
    ...
    public partial class DirectPostRequest : IEquatable<DirectPostRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="tokenise">Boolean flag which defines whether the response data is tokenised for further presentation at a later authorisation stage. A value of false will effectively turn off tokenisation and present the transaction immediately upstream to the acquirer. .</param>
        ...
        /// <summary>
        /// Boolean flag which defines whether the response data is tokenised for further presentation at a later authorisation stage. A value of false will effectively turn off tokenisation and present the transaction immediately upstream to the acquirer. 
        /// </summary>
        /// <value>Boolean flag which defines whether the response data is tokenised for further presentation at a later authorisation stage. A value of false will effectively turn off tokenisation and present the transaction immediately upstream to the acquirer. </value>
        [DataMember(Name = "tokenise", EmitDefaultValue = true)]
        public bool Tokenise { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Tokenise: ").Append(Tokenise).Append("\n");
        ...
        {
            return this.Equals(input as DirectPostRequest);
        }

        /// <summary>
        /// Returns true if DirectPostRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectPostRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Tokenise == input.Tokenise ||
                    this.Tokenise.Equals(input.Tokenise)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.Tokenise.GetHashCode();

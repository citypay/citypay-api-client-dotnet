...
namespace CityPayAPI.Model
{
    ...
    public partial class DirectTokenAuthRequest : IEquatable<DirectTokenAuthRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DirectTokenAuthRequest);
        }

        /// <summary>
        /// Returns true if DirectTokenAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectTokenAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
